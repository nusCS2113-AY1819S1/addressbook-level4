...
* It is a Java application intended for CG lab workers searching for experiment apparatus.
* It can help CG lab workers to check the status evey experiment items (the quantity and whether available in lab).
...
* CG lab represents module CG1111 and module CG1112, which are two important computer engineering modules.
