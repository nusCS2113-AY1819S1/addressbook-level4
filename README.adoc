...
* It is specially designed just for Store Owners to keep manage their books and revenue for their store.
* As customers, you can also check the availability of the items they are looking for before heading down to the store.
