...
== About App
FrozenBook is a comprehensive inventory management system targeted at small-scale drink distribution companies that  typically use Microsoft Excel or paper to keep track of their stocks. 
