...
Record feature allows the user to update club information all at once.

E.g:  `Bernice` pays `$100` membership fee, attends `Basketball training on 01/11` and borrows
`1 chair`.
...
*  Add an event a basketball event on 01/11

*  Take away 1 chair from the inventory
