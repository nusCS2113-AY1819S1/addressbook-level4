...
=== Search for a product: search <product name>

Format: `search <product name>`            
...
=== Add a product: add product name <product name>

Format: `add product name <product name>`  

Adds a product to the list of products offered by the store

=== List all distributors: distributors

Format: `distributors`

List all distributors the store is in touch with

=== Search for a distributor: search <distributor name>

Format: `search <distributor_name>`

Displays the distributor and basic information related to it
Adds a distributor to the address book.

=== Add a distributor: add distributor name <distributor name>

Format: `add distributor name <distributor name>`
