...
* `login A1234568M zaq1xsw2cde3 member` +
Logs into Address book with user ID as A1234568M, password as zaq1xsw2cde3 and role as member.
...
* `createaccount X1234567X zaq1xsw2cde3 member` +
