...
****
* You will only receive reminders for events that they have *registered* for.
...
* Close the event alert dialog using your mouse or by hitting 'enter' on your keyboard.
****
// end::eventReminders[]
...
.A 'Completed' Status
image::Completed.png[width="100"]
.A 'Upcoming' Status
image::Upcoming.png[width="100"]
...
* `export myCalendar` +
Exports the iCalendar file with name 'myCalendar' to *folder that you store EventManager*
