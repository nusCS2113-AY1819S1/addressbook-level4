...
* `signup u/Gerald Chua p/password12345 c/password12345` +
Creates account for Gerald Chua
* `signup u/James Yaputra p/drowssap12345 c/drowssap12345` +
...
* `signup n/Gerald Chua p/password12345` +
Creates Gerald Chua +
* `signup u/James Yaputra p/drowssap12345` +
Creates James Yaputra
