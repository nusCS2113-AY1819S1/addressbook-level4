...
Format: `additem n/FOOD_ITEM_NAME r/RECIPE_NAME p/PRICE`

Examples:

* `additem n/Vanilla Icecream r/Vanilla Recipe p/2.50`
* `additem p/3.00 n/Hot Fudge Sundae r/Hot Fudge Sundae Recipe`
