...
The timetable content are 'locked', and a user is prompted with this login pop up box.

image::Security.png[width="790"]

Users will have to enter their credentials to show the hidden timetable contents
which they have clearance to look at. +
