...
=== Showing a summary table of all financial activity in a given time

Shows a table which contains a summary for each day or month within a given time specified by the user. +
