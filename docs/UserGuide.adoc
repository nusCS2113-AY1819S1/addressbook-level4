...
Admin/User: Finds events whose names, date, address, tags contain any of the given keywords. +
...
* `find 12/01/2018 04:30`
Return any event having `12/01/2018`, `04:30`
...
=== Export Calendar Command: exportCalendarCommand
...
[NOTE]
====
File name should not be longer than 500 characters.
====
