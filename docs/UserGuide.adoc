...
* Commands argument can be in any order e.g. 'AddCommand' Format: 'add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]'
          can also be 'n/NAME p/PHONE_NUMBER a/ADDRESS e/EMAIL add'
====
...
`schedule INDEX d/DDMMYYYY st/START-TIME et/END_TIME en/EVENT-NAME`
...
=== Add and Delete personal weekly schedule : `schedule` [coming in v1.4]

Format:

`addschedule INDEX d/DDMMYYYY st/START-TIME et/END-TIME en/EVENT-NAME`
`delschedule INDEX d/DDMMYYYY st/START-TIME et/END-TIME en/EVENT-NAME`
...
[TIP]
The user is unable to edit the content of the to-do task
