...
* You should be able to see the GUI with the following 'Enter Password' prompt as shown in Figure 1 below, in a few seconds.
+
.Password Prompt
...
image::OwnerAccess.png[width="450", align="left"]
+
.Prompt for Accountant if password is correct
image::AccountantAccess.png[width="450", align="left"]
+
.Prompt for Other Users if password is correct
image::OtherAccess.png[width="450", align="left"]
+
