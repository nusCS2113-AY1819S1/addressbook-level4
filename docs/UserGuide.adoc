...
==== Update Class Attendance List : `class modattend [coming in v1.4]`
...
==== Accessing class attendance list : `class listattend [coming in v1.4]`
...
==== Marking class attendance list : `class markattend [coming in v1.4]`
...
==== Modifying class attendance list : `class modattend [coming in v1.4]`
Modifies the class attendance list for the system. +
Format: `class modattend c/CLASS_NAME i/ADMISSION_NO`
