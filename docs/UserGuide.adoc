...
Notify when the deadline of tasks come in the following seven days +
No commands required

****
* The name of "urgent" tasks will turn yellow.
* The sum of "urgent" tasks will form a notification sentence after each operation.
****
