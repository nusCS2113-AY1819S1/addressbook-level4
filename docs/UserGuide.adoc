...
*DAY: `months [4, 6, 9, 11] have 30 days and [1, 3, 5, 7, 8, 10, 12] have 31 days)` +
*MONTH: `between 1 and 12, inclusive` +
*YEAR: `between 2018 and 9999, inclusive`
====
...
[NOTE]
====
Undoable commands: those commands that modify the address book's content (`add`, `complete`, `sort`, `add_milestone`, `defer_deadline`, `delete`, `select` and `clear`).
====
