...
. Enter "import"
. Key in n/, followed by name of drink
. Key in q/, followed by quantity imported 
. Press kbd:[enter]
. Check whether the transaction has been recorded successfully
.. If you see the message "import transaction recorded!", the transaction had been successfully entered into DrinkIo
.. If not, follow the instructions displayed in the message display pane, and re-enter the command

[WARNING]
====
The drink you want to transact must be recorded in DrinkIo
====
...
. Use the sell command
. Key in n/, followed by name of drink
. Key in q/, followed by quantity transacted in sale
. Press kbd:[enter]
. Check whether the transaction has been recorded successfully,
