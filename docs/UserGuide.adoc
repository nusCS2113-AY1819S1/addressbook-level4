...
****
* Default mode will list down all records in the Financial Planner and exports all of them to an Excel file.
* Single argument mode will list down all records with the specified date and exports all shown records to an
Excel file.
* Dual argument mode will list down all records with the date that fall on either dates or between both dates and
exports all shown records to an Excel file. +
****
...
Editlimit similar to <<deletelimit>> command, it is also based on the date period.
