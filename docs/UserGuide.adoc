...
* If a user wants to delete an added comment, use the undo CLI command.
****
...
* Comment cannot be blank. For C/String, String cannot be empty
* Line refers to the number of the comment indicated in  of the comment section. It has to be a non-zero integer and exist within the comment section. E.g. `1. Gerald : Hello` the line here is 1. `5. Gerald: Hi` the line here is 5. 
* All replied comments will fall under a comment that has no (REPLY) in front. Hence, all replies will be towards the same comment.
****
Examples:
