...
* Commands argument can be in any order +
e.g. 'AddCommand' Format:
+
`add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS
[t/TAG]` +
can also be +
`n/NAME p/PHONE_NUMBER a/ADDRESS e/EMAIL add` [available in V1.4]
====
...
// TODO: Add preface
// tag::export[]
=== Export all contacts displayed: `export`

// preface
You can save the hassle of typing in the exact same contact details of your group members if one of them have already
 done that.

To do so, simply ask him/her to export the contact details of all persons listed in JitHub to a file and share it
with the group. +
====
...
`find alex`
=====
image::findAlex.png[width="790"]
* Export to a xml file with specific filename. +
====
`export alex.xml`
====
image::exportAlex.png[width="790"]

[NOTE]
====
1.  The file will be located in `/data/FILENAME.xml`
2.  This command overwrites any files with the same name at `/data/`
====
// end::export[]
