...
. At the login page, enter username and password using either the CLI or GUI
...
[NOTE]
====
The example provided is a default login account for admins. This account is only created for testing purposes.
====

After login in, a confirmation message would be shown indicating your authentication level.
