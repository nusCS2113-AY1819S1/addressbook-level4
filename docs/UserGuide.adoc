...
Export all name, phone, address and email of all persons in the address book. +
...
[NOTE]
====
1.  The csv/vcf file will be located in `/data/pineapple.csv`.
2.  This command overwrites the previous `/data/pineapple.csv`.
====
