...
[NOTE]
====
1.  The file will be located in +
`<DIRECTORY OF YOUR JAR FILE>/data/FILENAME.xml`
2.  This command overwrites any files with the same name at +
`<DIRECTORY OF YOUR JAR FILE>/data/`
====
// end::export[]
