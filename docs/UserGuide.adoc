...
image::BeforeSelectDeadlineGUI.PNG[width="800"]
...
image::AfterSelectDeadlineGUI.PNG[width="800"]

 You have successfully selected a date.
...
Step 1. Alternatively, to make things even simpler, you can choose to use the Date Picker as highlighted below.

.Date Picker beside the command box
image::DatePickerPosition.PNG[width="800"]

Step 2. To use the Date Picker, click on the calender icon.

.Calander icon on Date Picker
image::DatePickerWhereToPress.PNG[width="800"]

Step 3.  you should be able to see a calendar.

.Calendar view of Date Picker after clicking on Calendar iocn
image::DatePickerSelectDate.PNG[width="800"]

Step 4. Use the left and right arrows to navigate to different months and years.

.Left and right arrow keys in Date Picker
image::DatePickerLeftRightArrows.PNG[width="800"]
...
Step 6. A success message will be shown as highlighted below.
...
.GUI before using edit command to change the title_
image::EditCommandBefore.PNG[width="800"]
...
image::EditCommandAfter.PNG[width="800"]
