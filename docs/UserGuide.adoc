...
****
* Edits the employee/person at the specified `INDEX`. The index refers to the index number shown in the displayed event list. The
...
* The index refers to the index number shown in the displayed person list and event list respectively.
* The index *must be a positive integer* 1, 2, 3, ...
* The person to be remove must be previously invited to an event in order to be removed.
****
