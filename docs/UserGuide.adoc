...
[NOTE]
====
Only the president is able to create new accounts. As such, you must log in with president login credentials to be able to create new accounts.
====
...
This is the first step in the budget allocation process!
...
This is the second step in the budget allocation process!
...
This is the third and final step in the budget calculation process!
