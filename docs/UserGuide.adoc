...
AddressBook Level 4 (AB4) is for those who *prefer to use a desktop app for managing their finances*. More
importantly, AB4 is *optimized for those who prefer to work with a Command Line Interface* (CLI) while still
having the benefits of a Graphical User Interface (GUI). If you can type fast, AB4 can get your finance management
...
* **`add`**`n/Grocery shoppings m/-70 d/20-9-2018 t/Shopping` : adds a contact named `Grocery shopping` to the Address Book.
