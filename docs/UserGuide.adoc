...
Beginning from the left, you should see a panel of books arranged. These are the available books
which the bookstore owners have placed up for display.
...
.Command Panel
image::CommandPanel.png[width="400", align="left"]
