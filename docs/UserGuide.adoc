...
Step 2. `deleteC 1,6,2` +
(Deletes the 1st, 2nd and 6th job in the job list)


==== Deleting job offer(s)
Format: `deletej <INDEX>,<INDEX> ...`
...
Step 2. `deletej 5,4` +
(Deletes the 4th and 5th job in the job list)
