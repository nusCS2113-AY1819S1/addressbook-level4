...
=== Import Timetable from a file : `import` (`im`)

Imports a timetable for the current user from a specified file. +

****
* Only supports (.ics) files exported from NUSMODS.
* When you type the command, do not include the (.ics) file extension.
* Important: The file should be placed in the folder `.\import_export\`, where the `.` represents the folder containing the application
****
...
* `import my_file` +
Imports the timetable at `.\import_export\my_file.ics` +
...
=== Export Timetable to a file : `export` (`ex`)

Exports the currently-displayed timetable to the specified file. +

****
* Your timetable will export as an (.ics) file
* When you type the command, do not include the (.ics) file extension.
* The file will be placed in the folder `.\import_export\`, where the `.` represents the folder containing the application
...
* `export file_name` +
Exports the currently displayed timetable to:  `.\import_export\file_name.ics`: +
