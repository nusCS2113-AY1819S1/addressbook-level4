...
{empty}[http://github.com/darylnigel[github]] [<<darylnigel#, portfolio>>]
...
{empty}[http://github.com/hyukiejun[github]] [<<hyukiejun#, portfolio>>]

Role: Developer +
Responsibilities: Code clean-up, Member feature, Docs

'''

=== Zhang Bo
image::allenzb.png[width="150", align="left"]
{empty}[http://github.com/AllenZB[github]] [<<zhangbo#, portfolio>>]
