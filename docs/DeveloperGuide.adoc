...
This Section below until Admin Management need to be edited :(
...
image::SDCheckAnnounce.png[width="200"]
...
image::SDBlockUserFromCreating.png[width="200"]
...
image::SDSetAdmin.png[width="200"]
...
image::SDCreateModule.png[width="200"]
...
image::SDDeleteModule.png[width="200"]
...
image::SDUpdatePass.png[width="200"]
...
image::SDDeleteUser.png[width="200"]
