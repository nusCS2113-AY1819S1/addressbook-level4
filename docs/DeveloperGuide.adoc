...
|=======================================================================
|Priority |As a ... |I want to ... |So that I can...
|`* * *` |busy employee |get information from the address book fast |I can get back to my work.

|`* * *` |secretary |information to be accurate |able to contact or refer to them.

|`* *` |busy employee |access information fast |can get back to what I am doing.

|`* *` |boss |keep my information in the address book safe |confidential information about employees will not be disclosed.

|`*` |efficient worker |address book to have a small and compact size |transfer information between machines easily.
|=======================================================================
...
Password handling is done in `PasswordCommand` class. +
Credentials obtained from the argument is then parsed to the `FileEncryptor` class. +
Encryption of the XML data file is done in `FileEncryptor` class using the credentials obtained earlier.
