...
[discrete]
=== 14. Use case: Delete an existing limit [Oscar]
...
[discrete]
=== 15. Use case: Add a monthly limit [Oscar]
...
[discrete]
=== 16. Use case: Edit the monthly limit [Oscar]
...
[discrete]
=== 17. Use case: Delete the monthly limit [Oscar]
...
[discrete]
=== 18. Use case: Check all the existing limits [Oscar]
...
[discrete]
=== 19. Use case: Export expenses into Excel file [Linh Chi]
...
[discrete]
==== 20. Use case: Import the Excel file into Financial Planner. [Linh Chi]
...
[discrete]
=== 21. Use case: Archive the records data into Excel file. [Linh Chi]
...
[discrete]
=== 22. Use case: See monthly financial activity
...
[discrete]
=== 23. Use case: Freely edit expenses tags
