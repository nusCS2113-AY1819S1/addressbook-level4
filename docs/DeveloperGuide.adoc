...
|`* *` |university lecturer |automatically distribute students into groups via criteria-based user options (gender/nationality) |efficiently from random groups
...
[none]
** 3b1. AddressBook asks user to create group.
+
Use case resumes at step 1.

[discrete]
=== Use case: Calendar (UC02)
*Precondition*

1.  Calender is created

*MSS*

1.  User adds group to date
2.  AddressBook confirms that group is added
+
Use case ends
...
** 1a1. AddressBook rejects command entered.
[none]
* 1b. AddressBook detects group is not created.
+

[none]
** 1b1. AddressBook rejects command entered.
[none]
** 1b2. AddressBook asks user to create group.
[none]
** 1b3. User creates group (UC01).
...
.  Should be user friendly and must not require education to use teh software
