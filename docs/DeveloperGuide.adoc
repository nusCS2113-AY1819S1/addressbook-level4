...
. Modify the link:{repoURL}/src/main/java/seedu.address/ui/StatusBarFooter.java[`StatusBarFooter`] to show the total number of people in the quantity book.
+
**Before**
+
...
** link:{repoURL}/src/main/java/seedu.address/ui/StatusBarFooter.java[`StatusBarFooter`] needs to initialize the status bar on application start, and to update it accordingly whenever the quantity book is updated.
* Solution
