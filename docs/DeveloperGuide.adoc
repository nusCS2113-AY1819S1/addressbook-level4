...
CURD feature is the basic commands to implement the Forum Book. It refers to create thread, update thread, read module, read thread, read comment and delete thread.
