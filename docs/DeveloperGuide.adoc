...
|`* * *` |university lecturer |send an email to all students in any group |make module specific announcements
...
1.  User requests to send email with specified content to a group
2.  AddressBook confirms with user that email was sent
+
Use case ends
...
[none]
* 1b. AddressBook detects email content exceeds word limit.
+
