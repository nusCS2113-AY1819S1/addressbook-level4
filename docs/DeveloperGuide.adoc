...
.. Prerequisites: Current user must login as an admin. Admin is unable to set/revert himself/herself to admin/user.
...
.. Prerequisites: Current user must be login as an admin.
