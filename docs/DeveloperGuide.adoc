...
>>>>>>> 70c1f055ca1e9ad3de1b1c26d7366fe1e98c659e
|=======================================================================
...
[discrete]
=== 2.  Use case: Delete expense entry.

*MSS*

1.  User requests to delete an entry
2.  FinancialPlanner requests for date of entry to be deleted
3.  User enters the date entry was added
4.  FinancialPlanner shows list of entries and requests for entry to be deleted
5.  User enters entry to be deleted
6.  FinancialPlanner entry confirms entry to be deleted
7.  User confirms the deletion
8.  FinancialPlanner deletes the entry
+
Use case ends.
...
* 7a User declines the confirmation.
** Use case resumes at step 4.

[discrete]
=== 3.  Use case: See history of expenses for a certain period

*MSS*

1.  User requests to see history.
2.  FinancialPlanner requests for the period intended
3.  User enters the intended period.
4.  FinancialPlanner requests for confirmation from user.
5.  User confirms the period.
6.  FinancialPlanner returns the history of all expenses within the period.
+
Use case ends.
...
* 5a. User declines the confirmation.
** Use case resumes at step 2.
* 6a. There is no history.
** FinancialPlanner notifies that there is no history.
** Use case ends.
** Use case resumes at step 6.
...
[discrete]
=== 6.  Use case: Search expenses based on category
...
[discrete]
=== 7.  Use case: Summary of expenditure by category
...
[discrete]
=== 11. Use case: Create daily limit for expenses
