...
2.  User adds in non-available time slots with event tag.
3.  Jithub shows user available time slots.
4.  User selects a group of persons.
5.  Jithub shows the common available time slots among all selected persons.
+
Use Case ends.

*Extensions*

* 2a. User requests to delete added schedule.
+
...
* 5a. No common time slots available.
+
Use Case ends.
