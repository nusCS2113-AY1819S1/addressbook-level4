...
The `invite` command allows users to add attendees to an existing event, represented by a `Event` object.
The command currently only allows users to add a single person to an event, based on the indices on the UI.
This command adds the invited `Person` 's name, which is unique, to a chosen `Event`, so that the attendees of a particular event is recorded.
...
*  `Attendees`
** Each `Event` object has a `Attendees`, which is a list of the names of the `Person` attending the event.
...
Step 6. Next, the `Person` object's name is obtained and added to the `Attendees` object. The new `Attendees` object is then added to a new copy of the `Event` object.
...
===== Aspect: How to link Person and Object
...
** Cons: We must add or assign an ID to each Persons. Unnecessary if name is unique and uneditable.
...
|`* * *` |Project Manager |Add a new person (Department Head or Employee) |To maintain a record of that person

|`* * *` |Project Manager |Delete a person (Department Head or Employee) |Remove entries that I no longer need
...
|`* * *` |Project Manager |Select a person |To know more information about the person

|`* * *` |Project Manager |Add a new event |To maintain a record of that event
...
|`* * *` |Project Manager |Invite department heads or employee to events |Tag the person to the relevant event
...
|`* * *` |Project Manager |Schedule for the time period |To have a calendar view of the events for that time period and
to keep track/ Plan schedule properly
...
|`* * *` |Project Manager |Exit command |

|`* * *` |New Department Head|See usage instructions |Refer to instructions when I forget how to use the ProManage

|`* * *` |Department Head |Add a new Employee |To maintain a record of that employee

|`* * *` |Department Head |Delete an Employee |Remove entries that I no longer need

|`* * *` |Department Head |Edit an employee's details |Change the relevant information

|`* * *` |Department Head |Find an employee by name |Locate details of employees without having to go through the entire list

|`* * *` |Department Head |List the people in alphabetical order by name or by department |View the whole list of
relevant people

|`* * *` |Department Head |Select an employee |To know more information about the employee

|`* * *` |Department Head |Add a new event |To maintain a record of that event

|`* * *` |Department Head |Delete an event |Remove events that are no longer relevant

|`* * *` |Department Head |Edit the information of an event |Update the relevant information

|`* * *` |Department Head |Invite employees to events |Tag the person to the relevant event

|`* * *` |Department Head |Remove employees from the event |Remove uninvolved employees from an event

|`* * *` |Department Head |Find an event |Locate details of the event without having to look through the entire list

|`* * *` |Department Head |Select an event |To know more information about the event

|`* * *` |Department Head |Schedule for the time period |To have a calendar view of the events for that time period and
to keep track/ Plan schedule properly

|`* * *` |Department Head |History of commands |To view the commands previously inserted into ProManage

|`* * *` |Department Head |Undo command |Undo my previously entered command

|`* * *` |Department Head |Redo command |Redo my previously undo command

|`* * *` |Department Head |Exit command |

|`* * *` |New Employee |See usage instructions |Refer to instructions when I forget how to use the ProManage

|`* * *` |Employee |Schedule for the time period |To have a calendar view of the events for that time period and
to keep track/ Plan schedule properly
|=======================================================================
