...
=== Sorting of contacts in addressbook feature
==== Current Implementation
...
might also encourage careless programing habits, which is wrong.
...
|`* * *` |user |view my enrolled classes | store my notes according to the classes I am enrolled in
