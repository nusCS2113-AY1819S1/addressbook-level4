...
|`* * *` |teacher |add grade componenents |differentiate the grade componenets in a module (E.g. mid term test, finals examination)
...
|`* * *` |teacher |create notes for my modules |keep track of important stuff regarding the module and also my own teaching progress

|`* * *` |teacher |delete notes from my modules |remove completed tasks or discard those that are no longer needed

|`* * *` |teacher |view saved notes from my modules |easily check up on important things I could have forgotten

|`* * *` |teacher |edit notes for my modules |efficiently make changes to my notes if needed without deleting and then adding a new one

|`* *` |teacher |assign priorities to my notes |make effective planning by looking for notes with higher importance

|`* *` |teacher |attach deadlines to my notes |keep track of upcoming deadlines and important dates
...
1.  Teacher adds grade component
2.  System successfully adds grade component.
+
Use case ends.
...
[none]
* 1a. Module code does not exist.
+
[none]
** 1a1. System outputs error in adding grade item due to wrong module code.
+
Use case ends.

[none]
* 1b. Invalid command entered.
+
[none]
** 1b1. System outputs an example of a valid input to run the 'add grade' command.
+
Use case ends.

[discrete]
=== Use case: Edit grade item

*MSS*

1.  Teacher edits grade item.
2.  System successfully updates grade item.
...
+
[none]
** 1a1. System outputs error in editing grade item due to wrong module code.
+
Use case ends.
...
+
[none]
** 1b1. System outputs an example of a valid input to run the 'edit grade' command.
+
Use case ends.

[discrete]
=== Use case: Delete grade item

*MSS*

1.  Teacher deletes grade item.
2.  System successfully deletes grade item.
...
+
[none]
** 1a1. System outputs error in deleting grade item due to wrong module code.
+
Use case ends.
...
+
[none]
** 1b1. System outputs an example of a valid input to run the 'delete grade' command.
+
Use case ends.

[discrete]
=== Use case: List grade items

*MSS*

1.  Teacher searches all grade item.
2.  System successfully displays all grade item.
...
+
[none]
** 1a1. System outputs error in listing grade item due to wrong module code.
+
Use case ends.
...
+
[none]
** 1b1. System outputs an example of a valid input to run the 'list grades' command.
+
Use case ends.

[discrete]
=== Use case: Assigning marks to a student

*MSS*

1.  Teacher assigns marks to student.
2.  System successfully saves the marks.
...
+
[none]
** 2a1. System outputs error in listing grade item due to wrong module code.
+
Use case ends.

[none]
* 2b. Invalid command entered.
+
[none]
** 2b1. System outputs an example of a valid input to run the 'list grades' command.
+
Use case resumes at step 1.
...
1.  Teacher wants to add a note to a module.
2.  System displays message of successful addition of a note to the module.
...
+
[none]
** 1b1. System informs the user that the module is not found.
+
Use case resumes at step 1.
...
1.  Teacher wants to view the notes saved in a specific module.
2.  System displays the complete list of notes saved in the module.
...
+
[none]
** 2b1. System informs the user that no notes were found.
+
Use case resumes at step 1.
...
1.  Teacher wants to delete a note saved in a specific module.
2.  System displays the full numbered list of notes from the module.
3.  Teacher selects the note to be deleted.
4.  System displays a message for the successful deletion.
...
+
[none]
** 2a1. System informs the user that no notes were found.
+
Use case resumes at step 1.
...
+
[none]
** 4a1. System informs the user that the input is invalid.
+
Use case resumes at step 1.
...
1.  Teacher wants to edit an existing note in a specific module.
2.  System displays the full numbered list of notes from the module.
3.  Teacher selects the note to be edited.
4.  System prompts the teacher to enter the modifications.
5.  Teacher can now modify the text.
6.  System displays a message for the successful modification.
...
[none]
* 3a. The teacher wishes to cancel the deletion.
+
[none]
** 3a1. System cancels the deletion process.
+
Use case resumes at step 1.
...
[none]
* 6a. The teacher wishes to cancel the modification.
+
[none]
** 6a1. System cancels the editing process.
+
Use case resumes at step 1.

[none]
* 6b. The modified note is an empty text.
+
[none]
** 6b1. System informs the user that the input is invalid.
+
