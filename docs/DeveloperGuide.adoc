...
Data is to be encrypted to protect from unauthorized access.
...
==== Design Considerations
*Aspect:* Encryption/decryption Algorithm
...
*   *Alternative 1 (proposed choice):* Intercept `XMLUtil` class.

// end::dataencryption[]

// tag::threadreminders[]
=== [Proposed] Thread Reminders
// end::threadreminders[]
== Documentation
