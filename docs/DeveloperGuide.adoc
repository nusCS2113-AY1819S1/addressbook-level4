...
. User executes `shortlist` command. RecruitBook enters a 4-stage process to shortlist a candidate for a job offer.
...
* **Alternative 2:** Shortlist command executes the 4-stage process by itself.
...
inside panelViewPlaceholder. If there a panel is duplicated, it will give errors.

// end::switchbook[]
>>>>>>> 8624448b95e9dc0ab978d23587b1e0c56593aeef
