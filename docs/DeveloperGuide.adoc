...
The following sequence diagram show the significant method calls for the execution of the `add` command. The execution of the `delete` is implemented in a similar manner.

.Sequence Diagram Showing the Execution of an `add` Command
