...
Whenever a user successfully logs in, or creates a new account, the application will create an Authenticated User in
...
Whenever a user logs in, the username is searched from userList returned by AppUsers. Once it matches a username, the input pasword is
