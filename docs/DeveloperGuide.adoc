...
* LinkList containing all person data from the address book
...
|`* * *` |university lecturer |create groups of students |have a list of all my students in a particular module/group
...
1.  Address Book is not empty

*MSS*

1.  User creates a group
2.  AddressBook confirms that group is created
3.  User adds students to group
4.  AddressBook confirms that students were added
+
Use case ends
...
[none]
** 1a1. AddressBook rejects command entered.
[none]
* 1b. AddressBook detects duplicate group.
+

[none]
** 1b1. AddressBook rejects command entered.
[none]
* 3a. AddressBook detects error in data entered.
+

[none]
** 3a1. AddressBook rejects command entered.
[none]
* 3b. AddressBook detects group is not created.
+

[none]
** 3b1. AddressBook rejects command entered.
+
...
1.  Group's exist in the AddressBook
