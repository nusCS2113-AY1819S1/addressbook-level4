...
// end::manualTestBackup[]

// tag::manualTestRestore[]
=== Restore of data
...
//@@author T0roloco
// tag::manualTestFindCommands[]
=== Finding persons by name, address and phone number
