...
They decide what is shown on the panels at any given moment.
The friends of the current user is iterated through and those that belong to the friend will be shown on the FriendListPanel. The rest of the users will be shown on PersonListPanel.
Both predicates will filter out the current user.
...
** Pros: Allow different predicates to be nested when more filtering commands are called.
