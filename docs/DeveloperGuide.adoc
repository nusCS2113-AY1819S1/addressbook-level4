...
[discrete]
=== 11. Use case: Create a normal limit for a period of time or a day [Oscar]
...
[discrete]
=== 12. Use case: Edit an existing normal limit [Oscar]
...
[discrete]
=== 13. Use case: Delete an existing limit [Oscar]
...
[discrete]
=== 14. Use case: Add a monthly limit [Oscar]
...
[discrete]
=== 15. Use case: Edit the monthly limit [Oscar]
...
[discrete]
=== 16. Use case: Delete the monthly limit [Oscar]
...
[discrete]
=== 17. Use case: Check all the existing limits [Oscar]
...
* 2a. There is no limit stored. +
** System shows no limit error.
** Use case ends.

[discrete]
=== 18. Use case: Export expenses into Excel file [Linh Chi]
...
[discrete]
==== 19. Use case: Import the Excel file into Financial Planner. [Linh Chi]
...
[discrete]
=== 20. Use case: Archive the records data into Excel file. [Linh Chi]
...
[discrete]
=== 21. Use case: Freely edit expenses tags
