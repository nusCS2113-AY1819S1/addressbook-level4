 ...
 *MSS*
 ...
 7.  Reminders will be sent out every 6 hours to remind the logged-in user of events that he/she has registered for, that are happening in the next 24 hours.
 8.  (Reminder sent) Reminder sends alert dialog and automatically redirects user to the specified event's information panel.
 9.  User hits enter to close reminder.
 +
// end::reminderUsecase[]
