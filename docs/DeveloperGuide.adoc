...
// TODO: edit the steps
Step 1. The user calls the exportall command for the first time. A new `pineapple.csv` will be created at the path
defined in `outputFilepath`, which is hardcoded as `/data/pineapple.csv` for now.
