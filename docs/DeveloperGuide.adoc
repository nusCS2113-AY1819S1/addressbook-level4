...
===== Aspect: Data Structure to Support Sort Command

* **Alternative 1 (current choice):** Uses comparator on List data structure to sort the observable filtered list through sort method implemented in `UniquePersonList`.
** Pros: Easy to implement.
...
image::EncryptCommandSD.png[width="400"]
...
1.  User requests to add additional information for patient.
2.  System adds additional information for the patient and displays a message that entry for additional information is successful.
+
Use case ends.
...
[none]
* 1a. User uses the wrong format to add additional information i.e. wrong command or invalid data for the fields.
+
[none]
** 1a1. System shows error message that format is wrong and gives user an example on the correct format for adding of additional information.
+
Use case ends.
...
+
[none]
** 1a1. System shows an error message that the format is wrong and gives user an example on the correct format of adding appointment or the correct format of the respective invalid data.
+
Use case ends.
...
+
[none]
** 1a1. System shows an error message that the format is wrong and gives user an example on the correct format of editing appointment or the correct format of the respective invalid data.
+
Use case ends.
...
+
[none]
** 1a1. System shows an error message that the format is wrong and gives user an example on the correct format of deleting appointment or the correct format of the respective invalid data.
+
Use case ends.
...
+
[none]
** 1a1. System shows an error message that the format is wrong and gives user an example on the correct format of clearing appointments or the correct format of the respective invalid data.
+
Use case ends.
...
.. Test case: `edithist 1 hsod/12-12-2012 hsd/12-12-2012 hsds/d` +
Expected: *PASS* +
If previous Medical History entry exists, discharge status will be updated to discharged.
However, current implementation does not auto refresh the discharge status for the entry. Users are required to click on the personcard to manually refresh the infopanel.
