...
Step 1. The user launches the application, click on an event or types `select INDEX` into the CLI. The comment section will be shown as such.

image::ShowCommentSection.png[width=""]
...
image::AddComment.png[width="800"]
...
image::ReplyComment.png[width="800"]
...
image::DeleteComment.png[width="800"]
