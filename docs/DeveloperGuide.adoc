...
*Precondition* : Module code must exist. +
*Guarantees* : TBC +
*MSS* : +
...
*Precondition* : Grade component and corresponding module must exist. +
*Guarantees* : Deleting grade component will also delete any grade items associated to it. +
*MSS* : +
...
*Precondition* : Module must exist. +
*Guarantees* : TBC +
*MSS* : +
...
*Precondition* : Students must be enrolled to the module. +
*Guarantees* : TBC +
*MSS* : +
...
*Precondition* : Students must be enrolled to the module and grade item details(MAX_MARKS, PERCENTAGE OF GRADE) must
exist. +
*Guarantees* : TBC +
...
*Precondition* : Grade component must exist. +
*Guarantees* : TBC +
