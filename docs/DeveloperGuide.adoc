...
1.  User requests to create limits for expenses different period of time or a day.
2.  FinancialPlanner requests for the maximum amount of spending for that period of time or the day.
3.  User enters the dateStart and dateEnd or the day and the amount of spending.
4.  FinancialPlanner records the amount in the hard drive.
5.  FinancialPlanner keeps tracking the spending during that period of time or that day.
