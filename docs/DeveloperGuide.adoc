...
4. Calendar shows the expenditure / income for each day visually or Expenditure 
5. Tracker shows the expenditure / income status by displaying the amount of money.
