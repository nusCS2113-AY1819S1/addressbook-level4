...
|`* * *` |teacher |edit notes for modules |efficiently make changes to my notes if needed without deleting and then adding a new one
...
2.  System adds the note to the module and displays a message that it is successfully added.
+
Use case ends.
