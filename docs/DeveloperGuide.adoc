...
=== RSVP
==== Current Implementation
The RSVP feature consists of the `register` & `unregister` command. Attendees of an event are stored in the `eventmanager.xml` file, in a similar fashion to the storage of tags.
