...
|`* * *` |user |log into the application with the relevant credentials |gain secure access to the application

|`* * *` |user |create a new account for the application |gain access to certain features of the application relevant to my role when I log in

|`* * *` |user |delete an existing account from the application |clear my login credentials from the application when I am not using it anymore

|`* * *` |user |change the password of an existing account |feel more secure about my account login credentials
...
1.  User chooses normal login and types in user ID and password
2.  NUSSU-Connect queries against login book and authorizes the user full access to NUSSU-Connect
+
Use case ends.
...
[none]
* 1a. User types in wrong password or user ID
+
[none]
** 1a1. NUSSU-Connect displays error message and continues disabling access to user
+
Use case ends.
...
2.  NUSSU-Connect creates new account with chosen login details, and shows successful execution message
+
Use case ends.
