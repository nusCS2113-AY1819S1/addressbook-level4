...
The import/export timetable feature allows users to import and export their timetables from/to external applications as .ics files.

The import/export feature consists of two parts: +
1. The backend, which handles the reading and writing of _.ics_ files, and the conversion between the .ics format and the TimeTable object. +
...
.Interactions between the Logic Component and Model Component for the `export` Command
