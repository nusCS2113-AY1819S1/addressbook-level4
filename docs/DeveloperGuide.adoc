...
Step 2: The `DistributeCommand` creates a new `DistributeAlgorithm` Object and fed in an input parameter of a `Distribute` Object which contains the extracted information in Step 1.
