...
Given below is the Sequence Diagram for interactions within the `Logic` component for the `execute("gradebook delete mc/CS2113 i/Assignment 1")` API call.

.Interactions Inside the Logic Component for the `gradebook delete mc/CS2113 i/Assignment 1` Command
