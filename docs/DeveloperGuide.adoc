...
Step 5: `ScriptCommand` will tend run the `execute` function and create a instance of `AddressBookParser` called `scriptParser`

* The scriptParser is used to parse all the commands that are in the `addpersons` Text File
