...
* The ChangeStatusCommand class has the execute method. Using the itemName, the item to update is obtained from the model class. A copy is created and changes are made to the copy. The copy then replaces the original item.
