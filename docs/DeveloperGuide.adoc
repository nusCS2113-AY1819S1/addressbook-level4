...
.. Expected: System would throw an error saying invalid command and show what modes the command can support.
...
. Entering `summary` command with modes and invalid prefixes
.. Test case: Enter `summary date m/` or `summary month m/` or `summary category m/`
.. Expected: System would throw error saying invalid command and provide a different error message depending on the mode similar to
the case with modes but no arguments.

. Entering `summary` command with modes and invalid arguments
.. Test case: Enter `summary date d/1--1` or `summary month d/1---1` or summary category d/apr-2018`
.. Expected:
...
.. Expected: The table should be empty and record should be unselected.
