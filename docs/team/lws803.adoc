...
* *Minor enhancement*: added the ability to search by different attributes so that you can hone in on their search results to find the person you are looking for.
