...
** Justification: This feature improves the product significantly because it is specially built for an educational institution. Unlike AB4, which is a general address book app -- Trajectory has support for student-specific fields.
