...
* *Minor enhancement #2*: add test cases to increase coverage.
...
** Community:
*** PRs reviewed: https://github.com[#20], https://github.com[#24], https://github.com[#47], https://github.com[#48], https://github.com[#74], https://github.com[#78], https://github.com[#82], https://github.com[#122]
