...
Something Daily is a desktop application using command-line interface. It allows user to add, delete or edit the task and expenditure. It also provides advanced features such as getting spending advice for following days and checking the tasks information and expenditure records of a particular day.
...
This product was developed by a team of four, for more information about the rest developers, you may find it in the `About Us` page. Given below are my contributions to the whole project.
...
3. Written test files to check whether Expenditure Tracker models work properly, which helps developers find out the bugs and logic error in models.
