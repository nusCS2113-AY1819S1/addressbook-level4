...
** What it does: allows the user to set multiple limits for different periods of time to better manage their spend.
All the limits will be stored and automatically check whether the limit has been exceeded.
The user will be reminded if limits have been exceeded.
** Justification:This feature improves the product significantly because user will be able to make plan for their expense in advance and store all the limits.
