...
** Community:
*** Contributed to issue discussions (link:https://github.com/CS2113-AY1819S1-T16-1/main/issues/280#issuecomment-435569592[#280])
*** Reported bugs and suggestions for other teams in the class (link:https://github.com/CS2113-AY1819S1-W13-4/main[W13-4])
