...
* *New Feature*: Added *the ability to create groups*
** What it does: Allows the lecturer to create groups in the student management system and displays the groups created on a separate panel.
** Justification: This feature is necessary as it allows the lecturer to organize the management system.
...
* *New Feature*: Added *the ability to select groups*
** What it does: Allows the lecturer to create groups in the student management system and displays the groups created on a separate panel.
** Justification: This feature is necessary as it allows the lecturer to organize the management system.
** Highlights: This feature required an in-depth analysis of storage alternatives as storing group data in a separate xml file would be more modular but difficult to implement, given our time constraints.

* *New Feature*: Added *the ability to add students to groups*
** What it does: Allows the lecturer to create groups in the student management system and displays the groups created on a separate panel.
** Justification: This feature is necessary as it allows the lecturer to organize the management system.
** Highlights: This feature required an in-depth analysis of storage alternatives as storing group data in a separate xml file would be more modular but difficult to implement, given our time constraints.

* *New Feature*: Added *the ability to delete groups*
** What it does: Allows the lecturer to create groups in the student management system and displays the groups created on a separate panel.
** Justification: This feature is necessary as it allows the lecturer to organize the management system.
** Highlights: This feature required an in-depth analysis of storage alternatives as storing group data in a separate xml file would be more modular but difficult to implement, given our time constraints.

* *New Feature*: Added *the ability to delete students from groups*
** What it does: Allows the lecturer to create groups in the student management system and displays the groups created on a separate panel.
** Justification: This feature is necessary as it allows the lecturer to organize the management system.
** Highlights: This feature required an in-depth analysis of storage alternatives as storing group data in a separate xml file would be more modular but difficult to implement, given our time constraints.
