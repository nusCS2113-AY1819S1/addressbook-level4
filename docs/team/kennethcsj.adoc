...
_BookInventory_ is a *multi-platform* desktop application catered *primarily* for store owners to manage their book supplies. It includes many basic and advance features such as adding, deleting and requesting of books in the inventory.

Users interact with _BookInventory_ using *Command Line Interface (CLI)*, and has a *Graphic User Interface (GUI)* created with JavaFX.

_BookInventory_ was developed by a team of four students over a period of one semester. The original source code was adapted from the Address Book (Level 4) project by SE-EDU.

_BookInventory_ started as a project for the following modules offered by the School of Computing, National University of Singapore:

* *CS2101* - Effective Communication for Computing Professionals

* *CS2113* - Software Engineering & Object-Oriented Programming

This Project Portfolio demonstrates my contributions and ability to write documentation for both User Guide and Developer Guide for _BookInventory_.
...
** Justification: These features improve the product significantly as stocking up and selling of books are done *daily* which make them the core functions of _BookInventory_. As such, the application should provide a convenient way to address them.
...
*** Updated the unique identifier for books to `ISBN`.
