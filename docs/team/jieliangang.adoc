...
*** In charge of Integration, Deliverable and Deadlines, and PR Reviews
** Enhancements to existing features:
*** Updated the GUI color scheme https://github.com/CS2113-AY1819S1-T16-2/main/pull/134[#134]
*** Updated the `add` and `edit` command to distinguish different employees by their unique work email address https://github.com/CS2113-AY1819S1-T16-2/main/pull/106[#106]
*** Updated the `find` command to search for employees via their email address https://github.com/CS2113-AY1819S1-T16-2/main/pull/111[#111]
*** Updated the `selectEvent` command to highlight selected event in UI https://github.com/CS2113-AY1819S1-T16-2/main/pull/142[#142]
...
*** Updated the Developer Guide to include `invite` and `select` command: https://github.com/CS2113-AY1819S1-T16-2/main/pull/58[#58] https://github.com/CS2113-AY1819S1-T16-2/main/pull/118[#118]
** Community:
