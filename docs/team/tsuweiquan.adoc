...
//* *Code contributed*: [https://nuscs2113-ay1819s1.github.io/dashboard/#=undefined&search=tsuweiquan[Functional code]]

* *Other contributions*:

** Project management:
*** Managed releases from `v1.1` - `v1.4` (6 releases) on GitHub
