...
*** Implemented Auto-complete when typing commands from the command text field (Pull request https://github.com/CS2113-AY1819S1-T16-1/main/pull/313[#313])
...
include::../UserGuide.adoc[tag=notesmanagementfeatures]
...
include::../DeveloperGuide.adoc[tag=notesexportimplementation]

include::../DeveloperGuide.adoc[tag=jomcruz93pppusecases1]

include::../DeveloperGuide.adoc[tag=jomcruz93pppusecases2]
