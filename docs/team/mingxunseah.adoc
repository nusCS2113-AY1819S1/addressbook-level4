...
RecruitBook is referenced from AddressBook 4 created by the SE-EDU team from NUS and further developed by my team.
...
Here is a list of the main features currently available in RecruitBook.

* Adding and Deletion of data
* Modifying of data
* Fetching of data
* Shortlisting
* Emailing
