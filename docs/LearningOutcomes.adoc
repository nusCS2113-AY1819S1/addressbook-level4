...
Note how tests below `src/test/java/systemtests` package (e.g link:{repoURL}/src/test/java/systemtests/RegisterCommandSystemTest.java[`RegisterCommandSystemTest.java`]) are system tests because they test the entire system end-to-end.
