...
public class MainWindowHandle extends StageHandle {
    ...
    private final CompanyDetailsPanelHandle companyDetailsPanel;
    ...
    public MainWindowHandle(Stage stage) {
        ...
        companyDetailsPanel = new
                CompanyDetailsPanelHandle(getChildNode(CompanyDetailsPanelHandle.COMPANY_DETAILS_VIEW_ID));
    ...
    public CompanyDetailsPanelHandle getCompanyListPanel() {
