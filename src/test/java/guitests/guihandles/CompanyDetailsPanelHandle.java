...
/**
 * Provides a handle for {@code CompanyDetailsPanel} containing the list of {@code CompanyCard}.
 */
public class CompanyDetailsPanelHandle extends NodeHandle<ListView<Company>> {
    public static final String COMPANY_DETAILS_VIEW_ID = "#companyDetailsView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Company> lastRememberedSelectedCompanyCard;

    public CompanyDetailsPanelHandle(ListView<Company> companyDetailsPanelNode) {
        super(companyDetailsPanelNode);
    }
    ...
    /**
     * Returns the company card handle of a company associated with the {@code index} in the list.
     * @throws IllegalStateException if the selected card is currently not in the scene graph.
     */
    ...
    private Company getPerson(int index) {
