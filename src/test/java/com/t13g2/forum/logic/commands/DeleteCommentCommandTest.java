...
public class DeleteCommentCommandTest {
    ...
    @Test
    public void execute_userLoggedInDeleteComment_deleteCommentSuccess() throws Exception {
        ...
        CommandTestUtil.assertCommandSuccess(deleteCommentCommand, model, commandHistory,
                String.format(deleteCommentCommand.MESSAGE_SUCCESS, deleteMessage), expectedModel);
    }

    @Test
    public void execute_userLoggedInNotCommentOwner_deleteCommentFailed() throws Exception {
        //set the current logged in user as a user.
        User validUser = TypicalUsers.JANEDOE;
        Context.getInstance().setCurrentUser(validUser);
        ...
        CommandResult commandResult = deleteCommentCommand.execute(model, commandHistory);
        assertEquals(Messages.MESSAGE_NOT_COMMENT_OWNER, commandResult.feedbackToUser);
    }

    @Test
    public void execute_userLoggedInNotUnderCurrentScope_deleteCommentFailed() throws Exception {
        //set the current logged in user as a user.
        User validUser = TypicalUsers.JANEDOE;
        Context.getInstance().setCurrentUser(validUser);
    ...
    public void execute_notLoggedInDeleteComment_deleteCommentFailed() throws Exception {
        ...
        DeleteCommentCommand deleteCommentCommand =
                new DeleteCommentCommand(comment.getId());
