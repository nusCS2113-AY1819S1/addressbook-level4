...
public class AddUserCommandTest {
    ...
    public void execute_attemptMultipleLogin_loginFailed() throws Exception {
        ...
        //thrown.expect(CommandException.class);
        thrown.expectMessage(String.format(LoginCommand.MESSAGE_USER_ACTIVE, validUserToLogin.getUsername()));
    ...
    public void execute_userLoginWithNullUserName_loginFailed() throws Exception {
        ...
        CommandTestUtil.assertCommandSuccess(loginCommand, model, commandHistory,
                String.format(User.MESSAGE_USER_NAME_CONSTRAINTS, null,
                        validUser.getPassword()), expectedModel);
    }
    ...
    public void execute_userLoginWithNullUserPassword_loginFailed() throws Exception {
        ...
        CommandTestUtil.assertCommandSuccess(loginCommand, model, commandHistory,
                String.format(User.MESSAGE_USER_PASSWORD_CONSTRAINTS, validUser.getUsername(),
                        null), expectedModel);
    }
}
