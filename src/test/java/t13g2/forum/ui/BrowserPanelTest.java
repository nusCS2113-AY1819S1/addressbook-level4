...
import t13g2.forum.commons.events.ui.PersonPanelSelectionChangedEvent;
...
public class BrowserPanelTest extends GuiUnitTest {
    ...
    public void display() throws Exception {
        ...
        URL expectedPersonUrl = new URL(BrowserPanel.SEARCH_PAGE_URL + TypicalPersons.ALICE.getName().fullName.replaceAll(" ", "%20"));
