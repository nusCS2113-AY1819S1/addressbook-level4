...
//
///**
// * A system test class for BookInventory, which provides access to handles of GUI components and helper methods
// * for test verification.
// */
//public abstract class BookInventorySystemTest {
//    @ClassRule
...
//        assertEquals(new BookInventory(expectedModel.getBookInventory()), testApp.readStorageBookInventory());
...
//
//    /**
//     * Asserts that the previous selected card is now deselected and the browser's url remains displaying the details
