...
import static t13g2.forum.logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static t13g2.forum.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static t13g2.forum.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static t13g2.forum.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static t13g2.forum.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static t13g2.forum.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static t13g2.forum.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static t13g2.forum.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static t13g2.forum.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static t13g2.forum.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static t13g2.forum.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
import static t13g2.forum.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.VALID_NAME_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.VALID_NAME_BOB;
import static t13g2.forum.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
import static t13g2.forum.logic.commands.CommandTestUtil.VALID_TAG_HUSBAND;
import static t13g2.forum.logic.parser.CliSyntax.PREFIX_TAG;
import static t13g2.forum.model.Model.PREDICATE_SHOW_ALL_PERSONS;
import static t13g2.forum.testutil.TypicalIndexes.INDEX_FIRST_PERSON;
import static t13g2.forum.testutil.TypicalIndexes.INDEX_SECOND_PERSON;
import static t13g2.forum.testutil.TypicalPersons.AMY;
import static t13g2.forum.testutil.TypicalPersons.BOB;
...
import t13g2.forum.logic.commands.EditCommand;
...
import t13g2.forum.testutil.PersonUtil;
