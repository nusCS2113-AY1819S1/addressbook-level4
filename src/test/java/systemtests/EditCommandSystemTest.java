...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  "
                + PHONE_DESC_BOB + " " + NAME_DESC_BOB + "  " + ADDRESS_DESC_BOB + DEPARTMENT_DESC_BOB + " "
                + TAG_DESC_HUSBAND + " ";
        Person editedPerson = new PersonBuilder(BOB).withEmail(VALID_EMAIL_ALICE).withTags(VALID_TAG_HUSBAND).build();
