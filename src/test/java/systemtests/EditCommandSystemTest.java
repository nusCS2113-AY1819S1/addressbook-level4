...
public class EditCommandSystemTest extends StockListSystemTest {
    ...
    public void edit() {
        ...
        assertTrue(getModel().getStockList().getItemList().contains(BOB));
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedItem = new ItemBuilder(BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).build();
        assertCommandSuccess(command, index, editedItem);
        ...
        /* Case: filtered item list, edit index within bounds of stock list and item list -> edited */
        ...
        /* Case: filtered item list, edit index within bounds of stock list but out of bounds of item list
         * -> rejected
         */
        showItemsWithName(KEYWORD_MATCHING_MEIER);
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_ITEM.getOneBased() + INVALID_PHONE_DESC,
                Phone.MESSAGE_PHONE_CONSTRAINTS);

        /* Case: invalid email -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_ITEM.getOneBased() + INVALID_EMAIL_DESC,
                Email.MESSAGE_EMAIL_CONSTRAINTS);

        /* Case: invalid address -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_ITEM.getOneBased() + INVALID_ADDRESS_DESC,
        ...
        /* Case: edit a item with new values same as another item's values but with different address -> rejected */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
