...
public class DeleteCommandSystemTest extends StockListSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered item list, delete index within bounds of stock list and item list -> deleted */
        ...
        /* Case: filtered item list, delete index within bounds of stock list but out of bounds of item list
         * -> rejected
         */
        showItemsWithName(KEYWORD_MATCHING_MEIER);
    ...
    /**
     * Removes the {@code Item} at the specified {@code index} in {@code model}'s stock list.
