...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        Event deletedEvent = removePerson(expectedModel, INDEX_FIRST_PERSON);
        String expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedEvent);
        ...
        expectedResultMessage = String.format(MESSAGE_DELETE_PERSON_SUCCESS, deletedEvent);
