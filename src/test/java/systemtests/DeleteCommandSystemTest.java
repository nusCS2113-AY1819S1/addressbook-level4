...
//
//public class DeleteCommandSystemTest extends BookInventorySystemTest {
//
...
//                getModel().getBookInventory().getBookList().size() + 1);
...
//     * {@code BookInventorySystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
...
//     * and selected card are expected to update accordingly depending on the card
