...
public class ClearCommandSystemTest extends ExpenseBookSystemTest {
    ...
    public void clear() {
        ...
        /* Case: selects first card in record list and clears address book -> cleared and no card selected */
