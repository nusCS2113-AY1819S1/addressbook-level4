...
import static seedu.address.logic.commands.SelectCommand.MESSAGE_SELECT_ITEM_SUCCESS;
...
public class SelectCommandSystemTest extends StockListSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered item list, select index within bounds of stock list but out of bounds of item list
         * -> rejected
         */
        ...
        /* Case: filtered item list, select index within bounds of stock list and item list -> selected */
        ...
        /* Case: select from empty stock list -> rejected */
        deleteAllItems();
