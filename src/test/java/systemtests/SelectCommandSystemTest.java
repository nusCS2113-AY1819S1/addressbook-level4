...
public class SelectCommandSystemTest extends StockListSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered item list, select index within bounds of address book but out of bounds of item list
         * -> rejected
         */
        ...
        /* Case: filtered item list, select index within bounds of address book and item list -> selected */
