...
import static seedu.address.logic.commands.SelectCommand.MESSAGE_SELECT_RECORD_SUCCESS;
...
public class SelectCommandSystemTest extends ExpenseBookSystemTest {
    @Test
    public void select() {
