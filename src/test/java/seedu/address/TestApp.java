...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyEventManager> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyEventManager> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableEManager(this.initialDataSupplier.get()),
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setEventManagerFilePath(saveFileLocation);
        return userPrefs;
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getEventManager()), new UserPrefs());
        ModelHelper.setFilteredList(copy, model.getFilteredEventList());
        return copy;
    }
