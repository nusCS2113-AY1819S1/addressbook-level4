...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyBookInventory> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyBookInventory> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableBookInventory(this.initialDataSupplier.get()),
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getBookInventory()), new UserPrefs());
