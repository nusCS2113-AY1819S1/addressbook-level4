...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyProductDatabase> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyProductDatabase> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableProductDatabase(this.initialDataSupplier.get()),
    ...
    public Path getStorageSaveLocation() {
        return storage.getProductInfoBookFilePath();
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getAddressBook()), (model.getDistributorBook()),
                new UserPrefs(), new UserDatabase(), new TestStorage());
        ModelHelper.setFilteredList(copy, model.getFilteredProductList());
        return copy;
    }
