...
public class XmlAdaptedEventTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedEvent person =
                new XmlAdaptedEvent(INVALID_NAME, VALID_CONTACT, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        XmlAdaptedEvent person =
                new XmlAdaptedEvent(VALID_NAME, VALID_CONTACT, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        XmlAdaptedEvent person =
                new XmlAdaptedEvent(VALID_NAME, VALID_CONTACT, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        XmlAdaptedEvent person =
                new XmlAdaptedEvent(VALID_NAME, VALID_CONTACT, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedEvent person =
                new XmlAdaptedEvent(VALID_NAME, VALID_CONTACT, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, invalidTags);
