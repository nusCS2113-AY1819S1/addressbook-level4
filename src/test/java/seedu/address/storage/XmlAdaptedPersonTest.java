...
public class XmlAdaptedItemTest {
    ...
    public void toModelType_validItemDetails_returnsItem() throws Exception {
        XmlAdaptedItem item = new XmlAdaptedItem(BENSON);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedItem item = new XmlAdaptedItem(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        XmlAdaptedItem item = new XmlAdaptedItem(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        XmlAdaptedItem item = new XmlAdaptedItem(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedItem item = new XmlAdaptedItem(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
