...
public class XmlAdaptedUserTest {
    ...
    private static final String INVALID_DISTRIBUTOR_BOOK_FILE_PATH = "invalid.xml";
    ...
    private static final String VALID_DISTRIBUTOR_BOOK_FILE_PATH = AMY.getDistributorBookFilePath().toString();
    ...
    public void toModelType_invalidUsername_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(INVALID_USERNAME, VALID_PASSWORD, VALID_ADDRESS_BOOK_FILE_PATH,
                        VALID_DISTRIBUTOR_BOOK_FILE_PATH, VALID_SALESHISTORY_FILE_PATH);
    ...
    public void toModelType_nullUsername_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(null, VALID_PASSWORD, VALID_ADDRESS_BOOK_FILE_PATH,
                        VALID_DISTRIBUTOR_BOOK_FILE_PATH, VALID_SALESHISTORY_FILE_PATH);
    ...
    public void toModelType_invalidPassword_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(VALID_USERNAME, INVALID_PASSWORD, VALID_ADDRESS_BOOK_FILE_PATH,
                        VALID_DISTRIBUTOR_BOOK_FILE_PATH, VALID_SALESHISTORY_FILE_PATH);
    ...
    @Test
    public void toModelType_invalidDistributorBookFilePath_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(VALID_USERNAME, VALID_PASSWORD, INVALID_ADDRESS_BOOK_FILE_PATH,
                        INVALID_DISTRIBUTOR_BOOK_FILE_PATH, VALID_SALESHISTORY_FILE_PATH);
        String expectedMessage = User.MESSAGE_AB_FILEPATH_CONSTRAINTS;
        Assert.assertThrows(IllegalValueException.class, expectedMessage, user::toModelType);
    }
    ...
    public void toModelType_invalidSalesHistoryFilePath_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(VALID_USERNAME, VALID_PASSWORD, INVALID_ADDRESS_BOOK_FILE_PATH,
                        VALID_DISTRIBUTOR_BOOK_FILE_PATH, INVALID_SALESHISTORY_FILE_PATH);
        String expectedMessage = User.MESSAGE_AB_FILEPATH_CONSTRAINTS;
        Assert.assertThrows(IllegalValueException.class, expectedMessage, user::toModelType);
    }
    ...
    @Test
    public void toModelType_nullDistributorBookFilePath_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(VALID_USERNAME, VALID_PASSWORD, VALID_ADDRESS_BOOK_FILE_PATH,
                        null, VALID_SALESHISTORY_FILE_PATH);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, "Distributor Book file path");
        Assert.assertThrows(IllegalValueException.class, expectedMessage, user::toModelType);
    }
    ...
    public void toModelType_nullSalesHistoryFilePath_throwsIllegalValueException() {
        XmlAdaptedUser user =
                new XmlAdaptedUser(VALID_USERNAME, VALID_PASSWORD, VALID_ADDRESS_BOOK_FILE_PATH,
                        VALID_DISTRIBUTOR_BOOK_FILE_PATH, null);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, "Sales History file path");
        Assert.assertThrows(IllegalValueException.class, expectedMessage, user::toModelType);
    }
