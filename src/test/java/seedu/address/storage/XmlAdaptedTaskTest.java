...
public class XmlAdaptedTaskTest {
    ...
    */
    ...
    public void toModelType_invalidDeadline_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(INVALID_DEADLINE, VALID_TITLE, VALID_DESCRIPTION, VALID_PRIORITY_LEVEL,
                        VALID_EXPECTED_NUM_OF_HOURS, null, false);
    ...
    public void toModelType_nullDeadline_throwsIllegalValueException() {
        XmlAdaptedTask task = new XmlAdaptedTask(null, VALID_TITLE, VALID_DESCRIPTION,
    ...
    public void toModelType_invalidPriorityLevel_throwsIllegalValueException() {
        XmlAdaptedTask task =
                new XmlAdaptedTask(VALID_DEADLINE, VALID_TITLE, VALID_DESCRIPTION,
    ...
    public void toModelType_nullPriorityLevel_throwsIllegalValueException() {
        XmlAdaptedTask person = new XmlAdaptedTask(VALID_DEADLINE, VALID_TITLE,
                VALID_DESCRIPTION, null, VALID_EXPECTED_NUM_OF_HOURS, null, false);
    ...
    public void toModelType_nullExpectedNumOfHours_throwsIllegalValueException() {
        XmlAdaptedTask person = new XmlAdaptedTask(VALID_DEADLINE, VALID_TITLE, VALID_DESCRIPTION,
    ...
    public void toModelType_nullTitle_throwsIllegalValueException() {
        XmlAdaptedTask task = new XmlAdaptedTask(VALID_DEADLINE, null, VALID_DESCRIPTION,
                VALID_PRIORITY_LEVEL, VALID_EXPECTED_NUM_OF_HOURS, null, false);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        XmlAdaptedTask task = new XmlAdaptedTask(VALID_DEADLINE, VALID_TITLE, null,
                VALID_PRIORITY_LEVEL, VALID_EXPECTED_NUM_OF_HOURS, null, false);
