...
public class XmlAdaptedRecordTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedRecord record =
                new XmlAdaptedRecord(INVALID_NAME, VALID_DATE, VALID_EMAIL, VALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedRecord record = new XmlAdaptedRecord(null, VALID_DATE, VALID_EMAIL, VALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        XmlAdaptedRecord record =
                new XmlAdaptedRecord(VALID_NAME, INVALID_DATE, VALID_EMAIL, VALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        XmlAdaptedRecord record = new XmlAdaptedRecord(VALID_NAME, null, VALID_EMAIL, VALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        XmlAdaptedRecord record =
                new XmlAdaptedRecord(VALID_NAME, VALID_DATE, INVALID_EMAIL, VALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_invalidExpense_throwsIllegalValueException() {
        XmlAdaptedRecord record =
                new XmlAdaptedRecord(VALID_NAME, VALID_DATE, VALID_EMAIL, INVALID_EXPENSE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedRecord record =
                new XmlAdaptedRecord(VALID_NAME, VALID_DATE, VALID_EMAIL, VALID_EXPENSE, invalidTags);
