...
public class XmlAddressBookStorageTest {
    ...
    @Test
    public void readAddressBook_invalidRecordAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidRecordAddressBook.xml");
    }

    @Test
    public void readAddressBook_invalidAndValidRecordAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidAndValidRecordAddressBook.xml");
    }
