...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_EXPENSE_AMY + VALID_DATE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DATE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + EXPENSE_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDate(VALID_DATE_BOB).withEmail(VALID_EMAIL_AMY).withExpense(VALID_EXPENSE_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditRecordDescriptorBuilder().withEmail(VALID_EMAIL_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_RECORD;
        String userInput = targetIndex.getOneBased() + DATE_DESC_AMY + EXPENSE_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + DATE_DESC_AMY + EXPENSE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + DATE_DESC_BOB + EXPENSE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;

        EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withDate(VALID_DATE_BOB)
                .withEmail(VALID_EMAIL_BOB).withExpense(VALID_EXPENSE_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_DATE_DESC + EXPENSE_DESC_BOB
                + DATE_DESC_BOB;
        descriptor = new EditRecordDescriptorBuilder().withDate(VALID_DATE_BOB).withEmail(VALID_EMAIL_BOB)
