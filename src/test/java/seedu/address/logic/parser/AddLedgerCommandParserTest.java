...
public class AddLedgerCommandParserTest {
    ...
    private AddLedgerCommandParser parser = new AddLedgerCommandParser();

    @Test
    public void parse_allFieldsPresent_success() {
        Ledger expectedLedger = new LedgerBuilder(DAY1).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddLedgerCommand(expectedLedger));
