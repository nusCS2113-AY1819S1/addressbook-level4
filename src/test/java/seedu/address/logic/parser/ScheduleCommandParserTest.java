...
public class ScheduleCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        // no index specified
        assertParseFailure(parser, VALID_DATE_EVENT1, MESSAGE_INVALID_FORMAT);
    ...
    //Tests below returns same object with different address due to Index calling different methods to get.
    //Will be ignored
    //    @Test
