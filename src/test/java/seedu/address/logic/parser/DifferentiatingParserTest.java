...
public class DifferentiatingParserTest {
    ...
    public void parseInput_valid_toggleRequestCommand() {
        ...
        assertTrue(parser.parseInput(string, prev));
    }
    ...
    //It is acceptable even if prev is null.
    @Test
    public void parseInput_toggleRequestCommand_prevEqualsNull() {
        string[0] = "togglerequest";
        prev = "request";
        assertTrue(parser.parseInput(string, null));
    }
    ...
    public void parseInput_undoCommand_prevIsNotRequest() {
        string[0] = "undo";
        prev = "edit";
        assertFalse(parser.parseInput(string, prev));
    }
