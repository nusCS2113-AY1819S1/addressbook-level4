...
public class TaskBookParserTest {
    ...
    private final TaskBookParser parser = new TaskBookParser(new AddTaskCommand(),
                                                    new ClearCommand(),
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddTaskCommandParserTest addTaskCommandParserTest = new AddTaskCommandParserTest();
        AddTaskCommandParserTest.ParserWithDate parser = new AddTaskCommandParserTest.ParserWithDate();
