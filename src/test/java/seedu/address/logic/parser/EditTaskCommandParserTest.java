...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_NEGATIVE_INDEX_DESC;
...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_ZERO_INDEX_DESC;
...
public class EditTaskCommandParserTest {
    ...
    public void parse_invalidIndexAndPreamble_failure() {
        // negative index
        assertParseFailure(parser, INVALID_NEGATIVE_INDEX_DESC + VALID_TITLE_1, MESSAGE_INVALID_INDEX);

        // zero index
        assertParseFailure(parser, INVALID_ZERO_INDEX_DESC + VALID_TITLE_1, MESSAGE_INVALID_INDEX);
