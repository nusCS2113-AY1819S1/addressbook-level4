...
public class AddCommandParserTest {
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        AddCommand expectedAddCommand = new AddCommand(expectedPerson);
        assertParseSuccess(NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + NOTE_DESC_AMY, expectedAddCommand);
    }
