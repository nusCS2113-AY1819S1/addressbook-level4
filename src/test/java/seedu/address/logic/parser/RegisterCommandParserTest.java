...
public class RegisterCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        RegisterCommand validRegisterCommand = new RegisterCommand(new User(new Username(VALID_LOGIN_USERNAME),
                new Password(VALID_LOGIN_PASSWORD)));

        //successful input
        assertParseSuccess(parser, LOGIN_VALID_DESC_USERNAME + LOGIN_VALID_DESC_PASSWORD, validRegisterCommand);
        ...
        assertParseSuccess(parser, LOGIN_VALID_DESC_USERNAME + LOGIN_VALID_DESC_USERNAME
                + LOGIN_VALID_DESC_PASSWORD, validRegisterCommand);
