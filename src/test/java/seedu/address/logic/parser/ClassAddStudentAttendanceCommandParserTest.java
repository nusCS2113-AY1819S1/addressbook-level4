...
/**
 * Provides a test for the class add student attendance command parser
 */
public class ClassAddStudentAttendanceCommandParserTest {
    private static ClassroomManager classroomManager;
    private ClassAddStudentAttendanceCommandParser parser = new ClassAddStudentAttendanceCommandParser();
    ...
    public void parse_missingCompulsoryField_failure() {
        ...
        // no parameters
        assertParseFailure(parser, ClassAddStudentAttendanceCommand.COMMAND_WORD, expectedMessage);
    }
