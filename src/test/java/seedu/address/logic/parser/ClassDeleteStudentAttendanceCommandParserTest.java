...
/**
 * Provides a test for the class delete student attendance command parser
 */
public class ClassDeleteStudentAttendanceCommandParserTest {
    private static ClassroomManager classroomManager;
    private ClassDeleteStudentAttendanceCommandParser parser = new ClassDeleteStudentAttendanceCommandParser();
    ...
    public void parse_missingCompulsoryField_failure() {
        ...
        // no parameters
        assertParseFailure(parser, ClassDeleteStudentAttendanceCommand.COMMAND_WORD, expectedMessage);
    }
