...
/**
 * Contains integration tests (interaction with the Model, UndoCommand and RedoCommand) and unit tests for StudentEditCommand.
 */
public class EditCommandTest {
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        StudentEditCommand editCommand = new StudentEditCommand(indexLastPerson, descriptor);
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        StudentEditCommand editCommand = new StudentEditCommand(INDEX_FIRST_PERSON, new EditPersonDescriptor());
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        assertCommandFailure(editCommand, model, commandHistory, StudentEditCommand.MESSAGE_DUPLICATE_PERSON);
    }
    ...
    @Test
    public void equals() {
        final StudentEditCommand standardCommand = new StudentEditCommand(INDEX_FIRST_PERSON, DESC_AMY);
        ...
        assertFalse(standardCommand.equals(new StudentEditCommand(INDEX_SECOND_PERSON, DESC_AMY)));

        // different descriptor -> returns false
        assertFalse(standardCommand.equals(new StudentEditCommand(INDEX_FIRST_PERSON, DESC_BOB)));
    }
