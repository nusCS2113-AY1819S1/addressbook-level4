...
public class EditCommandTest {
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        EditItemDescriptor descriptor = new EditItemDescriptorBuilder().withName(VALID_NAME_BOB)
    ...
    public void execute_duplicateItemFilteredList_failure() {
        ...
        // edit item in filtered list into a duplicate in stock list
    ...
    public void execute_invalidItemIndexUnfilteredList_failure() {
        ...
        EditItemDescriptor descriptor = new EditItemDescriptorBuilder().withName(VALID_NAME_BOB).build();
     ...
     * but smaller than size of stock list
     */
    @Test
    public void execute_invalidItemIndexFilteredList_failure() {
        showItemAtIndex(model, INDEX_FIRST_ITEM);
        Index outOfBoundIndex = INDEX_SECOND_ITEM;
        // ensures that outOfBoundIndex is still in bounds of stock list list
    ...
    public void executeUndoRedo_invalidIndexUnfilteredList_failure() {
        ...
        // execution failed -> stock list state not added into model
        assertCommandFailure(editCommand, model, commandHistory, Messages.MESSAGE_INVALID_ITEM_DISPLAYED_INDEX);

        // single stock list state in model -> undoCommand and redoCommand fail
    ...
    public void equals() {
        ...
        EditItemDescriptor copyDescriptor = new EditItemDescriptor(DESC_AMY);
