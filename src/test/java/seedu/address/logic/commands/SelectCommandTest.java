...
public class SelectCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        Index lastPersonIndex = Index.fromOneBased(model.getFilteredProductList().size());
    ...
    public void execute_invalidIndexUnfilteredList_failure() {
        Index outOfBoundsIndex = Index.fromOneBased(model.getFilteredProductList().size() + 1);

        assertExecutionFailure(outOfBoundsIndex, Messages.MESSAGE_INVALID_PRODUCT_DISPLAYED_INDEX);
    }
    ...
    private void assertExecutionSuccess(Index index) {
        ...
        String expectedMessage = String.format(SelectCommand.MESSAGE_SELECT_PRODUCT_SUCCESS, index.getOneBased());
