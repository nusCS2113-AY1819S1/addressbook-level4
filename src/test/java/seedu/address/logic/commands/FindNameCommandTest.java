...
public class FindNameCommandTest {
    ...
    public void equals() {
        ...
        FindNameCommand findFirstNameCommand = new FindNameCommand(firstPredicate);
        FindNameCommand findSecondNameCommand = new FindNameCommand(secondPredicate);

        // same object -> returns true
        assertTrue(findFirstNameCommand.equals(findFirstNameCommand));

        // same values -> returns true
        FindNameCommand findFirstNameCommandCopy = new FindNameCommand(firstPredicate);
