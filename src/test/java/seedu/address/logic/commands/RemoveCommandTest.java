 ...
 * and unit tests for RemoveCommand.
 */
public class RemoveCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        Event eventUpdated = new EventBuilder(eventChosen).withAttendee().build();
    ...
    public void equals() {
        ...
        RemoveCommand command3 = new RemoveCommand(INDEX_SECOND_PERSON, INDEX_FIRST_EVENT);
