 ...
 * unit tests for EditItemCommand.
 */
public class EditItemCommandTest {
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() {
        ...
        Item editedItem = itemInList.withItemName(VALID_ITEM_NAME_BANANA).withItemQuantity(VALID_ITEM_QUANTITY_BANANA)
                .withItemLocation(VALID_ITEM_LOCATION_BANANA).build();

        EditItemCommand.EditItemDescriptor descriptor = new EditItemDescriptorBuilder()
                .withItemName(VALID_ITEM_NAME_BANANA).withItemQuantity(VALID_ITEM_QUANTITY_BANANA)
                .withItemLocation(VALID_ITEM_LOCATION_BANANA).build();
    ...
    public void execute_filteredList_success() {
        ...
        Item editedItem = new ItemBuilder(itemInFilteredList).withItemName(VALID_ITEM_NAME_BANANA).build();
        EditItemCommand editItemCommand = new EditItemCommand(INDEX_FIRST_ITEM,
                new EditItemDescriptorBuilder().withItemName(VALID_ITEM_NAME_BANANA).build());
    ...
    public void execute_invalidItemIndexUnfilteredList_failure() {
        ...
        EditItemCommand.EditItemDescriptor descriptor = new EditItemDescriptorBuilder()
                .withItemName(VALID_ITEM_NAME_BANANA).build();
    ...
    @Test
    public void equals() {
        final EditItemCommand standardCommand = new EditItemCommand(INDEX_FIRST_ITEM, DESC_APPLE);

        // same values -> returns true
        EditItemCommand.EditItemDescriptor copyDescriptor = new EditItemCommand.EditItemDescriptor(DESC_APPLE);
        ...
        assertFalse(standardCommand.equals(new EditItemCommand(INDEX_SECOND_ITEM, DESC_APPLE)));

        // different descriptor -> returns false
        assertFalse(standardCommand.equals(new EditItemCommand(INDEX_FIRST_ITEM, DESC_BANANA)));
    }
