...
public class BrowserPanelTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        selectionChangedEventStub = new ItemPanelSelectionChangedEvent(ALICE);
    ...
    public void display() throws Exception {
        ...
        URL expectedItemUrl = new URL(BrowserPanel.SEARCH_PAGE_URL + ALICE.getName().fullName.replaceAll(" ", "%20"));
