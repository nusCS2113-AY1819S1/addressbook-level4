...
public class AutoCompleteArgumentsParserTest {
    ...
    public void parse_nonEmptyValidArgs_returnValidPrefix() {
        ...
        AutoCompleteParserPair actualFindPair = AutoCompleteArgumentsParser.parse(COMMAND_FIND, " n/john", argumentMultimap);
        ...
        AutoCompleteParserPair actualListPair = AutoCompleteArgumentsParser.parse(COMMAND_LIST, " t/friends", argumentMultimap);
        AutoCompleteParserPair expectedListPair = new AutoCompleteParserPair(PREFIX_TAG, "friends");

        AutoCompleteParserPair actualMailPair = AutoCompleteArgumentsParser.parse(COMMAND_MAIL, " t/friends", argumentMultimap);
    ...
    public void parse_emptyArgs_returnCommandPrefix() {
        AutoCompleteParserPair actualPair = AutoCompleteArgumentsParser.parse(COMMAND_FIND, "", argumentMultimap);
    ...
    public void parse_unspecifiedArgsPrefix_returnDefaultPrefix() {
        AutoCompleteParserPair actualFindPair = AutoCompleteArgumentsParser.parse(COMMAND_FIND, "john", argumentMultimap);
        AutoCompleteParserPair expectedFindPair = new AutoCompleteParserPair(PREFIX_NAME, "john");

        AutoCompleteParserPair actualListPair = AutoCompleteArgumentsParser.parse(COMMAND_LIST, "john", argumentMultimap);
        AutoCompleteParserPair expectedListPair = new AutoCompleteParserPair(PREFIX_INVALID, "john");

        AutoCompleteParserPair actualMailPair = AutoCompleteArgumentsParser.parse(COMMAND_MAIL, "john", argumentMultimap);
    ...
    public void parse_invalidArgs_returnInvalidPrefix() {
        AutoCompleteParserPair actualPair = AutoCompleteArgumentsParser.parse("invalidCommand", "arg", argumentMultimap);
