...
import static seedu.address.testutil.TypicalTasks.CS2113_TASK_3;
...
public class VersionedTaskBookTest {
    ...
    private final ReadOnlyTaskBook addressBookWithTask1 = new TaskBookBuilder().withTask(CS2113_TASK_1).build();
    private final ReadOnlyTaskBook addressBookWithTask2 = new TaskBookBuilder().withTask(CS2113_TASK_2).build();
    private final ReadOnlyTaskBook addressBookWithTask3 = new TaskBookBuilder().withTask(CS2113_TASK_3).build();
    private final ReadOnlyTaskBook emptyAddressBook = new TaskBookBuilder().build();
