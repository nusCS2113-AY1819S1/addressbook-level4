...
public class NameTest {
    ...
    public void isValidName() {
        ...
        // valid name
        assertTrue(Name.isValidName("arduino")); // alphabets only
        assertTrue(Name.isValidName("12345")); // numbers only
        assertTrue(Name.isValidName("arduino the 2nd")); // alphanumeric characters
        assertTrue(Name.isValidName("Arduino")); // with capital letters
