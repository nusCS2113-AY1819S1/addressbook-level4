...
import seedu.address.model.VersionedProductDatabase;
...
public class VersionedAddressBookTest {
    ...
    public void commit_singleAddressBook_noStatesRemovedCurrentStateSaved() {
        VersionedProductDatabase versionedAddressBook = prepareAddressBookList(emptyAddressBook);
    ...
    public void commit_multipleAddressBookPointerAtEndOfStateList_noStatesRemovedCurrentStateSaved() {
        VersionedProductDatabase versionedAddressBook = prepareAddressBookList(
    ...
    public void undo_singleAddressBook_throwsNoUndoableStateException() {
        ...
        assertThrows(VersionedProductDatabase.NoUndoableStateException.class, versionedAddressBook::undo);
    }
    ...
    public void redo_singleAddressBook_throwsNoRedoableStateException() {
        ...
        assertThrows(VersionedProductDatabase.NoRedoableStateException.class, versionedAddressBook::redo);
    }
    ...
    @Test
    public void equals() {
        VersionedProductDatabase versionedAddressBook = prepareAddressBookList(addressBookWithAmy, addressBookWithBob);

        // same values -> returns true
        VersionedProductDatabase copy = prepareAddressBookList(addressBookWithAmy, addressBookWithBob);
        ...
        VersionedProductDatabase differentAddressBookList = prepareAddressBookList(addressBookWithBob, addressBookWithCarl);
        assertFalse(versionedAddressBook.equals(differentAddressBookList));

        // different current pointer index -> returns false
        VersionedProductDatabase differentCurrentStatePointer = prepareAddressBookList(
     ...
     */
    private void assertAddressBookListStatus(VersionedProductDatabase versionedAddressBook,
        ...
        assertEquals(new ProductDatabase(versionedAddressBook), expectedCurrentState);
        ...
        for (ReadOnlyAddressBook expectedAddressBook : expectedStatesBeforePointer) {
            assertEquals(expectedAddressBook, new ProductDatabase(versionedAddressBook));
            versionedAddressBook.redo();
        }
     ...
     */
    private VersionedProductDatabase prepareAddressBookList(ReadOnlyAddressBook... addressBookStates) {
        assertFalse(addressBookStates.length == 0);

        VersionedProductDatabase versionedAddressBook = new VersionedProductDatabase(addressBookStates[0]);
     ...
     */
    private void shiftCurrentStatePointerLeftwards(VersionedProductDatabase versionedAddressBook, int count) {
