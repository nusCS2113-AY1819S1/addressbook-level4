...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthBookIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthBookIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthBookIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthBookIndex.equals(fifthBookIndex));

        // null -> returns false
        assertFalse(fifthBookIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthBookIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthBookIndex.equals(Index.fromOneBased(1)));
    }
}
