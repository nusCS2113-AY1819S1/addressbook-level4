...
public class TypicalExpenditures {
    ...
    public static final Expenditure CHICKEN = new ExpenditureBuilder().withDescription("Chicken rice")
            .withCategory("Food").withDate("01-01-2018").withMoney("12").build();
    public static final Expenditure HM = new ExpenditureBuilder().withDescription("HM hoodie")
            .withCategory("Clothing").withDate("01-01-2018").withMoney("100").build();
    public static final Expenditure IPHONE = new ExpenditureBuilder().withDescription("iPhone")
            .withCategory("Electronics").withDate("03-02-2018").withMoney("2000").build();
