...
public class TypicalPersons {
    ...
    public static final Product AMY = new ProductBuilder().withName(VALID_NAME_AMY).withSerialNumber(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Product BOB = new ProductBuilder().withName(VALID_NAME_BOB).withSerialNumber(VALID_PHONE_BOB)
