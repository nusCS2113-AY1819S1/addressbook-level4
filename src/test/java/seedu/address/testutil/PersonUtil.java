...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        if (person.kpiDoesExist()) {
            sb.append(PREFIX_KPI + person.getKpi().value + " ");
        }
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        if (!descriptor.isRemovePosition()) {
            descriptor.getPosition().ifPresent(position -> sb.append(PREFIX_POSITION)
                    .append(position.value).append(" "));
        }
        if (!descriptor.isRemoveKpi()) {
            descriptor.getKpi().ifPresent(kpi -> sb.append(PREFIX_KPI).append(kpi.value).append(" "));
        }
        if (!descriptor.isRemoveNote()) {
        ...
        System.out.println("Descriptor " + sb.toString());
        return sb.toString();
    }
}
