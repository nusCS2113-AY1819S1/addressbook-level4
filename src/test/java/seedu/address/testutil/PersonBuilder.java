...
public class PersonBuilder {
    ...
    public PersonBuilder(Person personToCopy) {
        ...
        enrolledModules = new TreeMap<>(personToCopy.getEnrolledModules());
        timeslots = new HashMap<>(personToCopy.getTimeSlots());
    }
    ...
    public Person build() {
        return new Person(name, phone, email, address, tags, enrolledModules, timeslots);
    }
