...
public class TypicalGroups {
    ...
    public static final Group TUT_1 = new GroupBuilder().withGroupName(VALID_GROUP_NAME_TUT_1).withGroupLocation(VALID_GROUP_LOCATION_TUT_1)
            .withTags(VALID_GROUP_TAG_TUT_1).build();
    public static final Group CS1010 = new GroupBuilder().withGroupName(VALID_GROUP_NAME_CS1010).withGroupLocation(VALID_GROUP_LOCATION_CS1010)
