...
/**
 * A utility class that helps with building predicate for {@Code CandidateContainsFilterKeywordsPredicate}
 * from a string of input arguments
 */

public class CandidateContainsFilterKeywordsPredicateBuilder {
    ...
    private CandidateContainsFilterKeywordsPredicate candidatePredicate;

    public CandidateContainsFilterKeywordsPredicateBuilder (String userInput) throws ParseException {
        this.candidatePredicate = preparePredicate(userInput);
    }

    public CandidateContainsFilterKeywordsPredicate getCandidatePredicate() {
     ...
     */
    private CandidateContainsFilterKeywordsPredicate preparePredicate (String userInput) throws ParseException {
        ...
        return new CandidateContainsFilterKeywordsPredicate(keywordsList);
    }
}
