...
import static seedu.recruit.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCandidateCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Address.MESSAGE_ADDRESS_CONSTRAINTS); // invalid recruit
