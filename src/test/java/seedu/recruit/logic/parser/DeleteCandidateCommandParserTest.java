 ...
 * outside of the DeleteCandidateCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DeleteCandidateCommand, and therefore we test only one of them.
...
public class DeleteCandidateCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteCandidateCommand(getIndexSet(INDEX_FIRST)));
    }
