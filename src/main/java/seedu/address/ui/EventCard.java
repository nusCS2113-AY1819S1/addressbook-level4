...
public class EventCard extends UiPart<Region> {
    ...
    public EventCard(Event event, int displayedIndex) {
        ...
        venue.setText("Venue:   " + event.getVenue().ThisVenue);
        description.setText("Description:   " + event.getDescription().ThisDescription);
        date.setText("Date:   " + event.getEventDate().ThisDate);
