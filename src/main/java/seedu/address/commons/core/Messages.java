...
public class Messages {
    ...
    public static final String MESSAGE_INVI_TEST = "This test name or test mark is invalid, it should not contain any space";
    ...
    public static final String MESSAGE_PERSONS_NOT_FOUND = "%1$d persons found!";
