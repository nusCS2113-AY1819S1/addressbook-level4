...
public class Messages {
    ...
    public static final String MESSAGE_COMPLETED_TASK = "The task is already marked as completed";
    public static final String MESSAGE_UNCOMPLETED_TASK = "The task is already marked as uncompleted";
