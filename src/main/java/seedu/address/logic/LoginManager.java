...
public class LoginManager {
    ...
    private static boolean isCreatingAccount = false;
    ...
    public static boolean getIsCreatingAccount() {
    ...
    public static void setIsCreatingAccount(boolean setCreatingAccount) {
