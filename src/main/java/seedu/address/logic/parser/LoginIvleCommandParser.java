...
import seedu.address.logic.commands.LoginIvleCommand;
...
public class LoginIvleCommandParser implements Parser {

    @Override
    public LoginIvleCommand parse(String args) throws ParseException{
        ...
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args,PREFIX_USERNAME,PREFIX_PASSWORD,PREFIX_MODULECODE);
         ...
         if (!arePrefixesPresent(argMultimap,PREFIX_PASSWORD,PREFIX_USERNAME,PREFIX_MODULECODE)){
             throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, LoginIvleCommand.MESSAGE_USAGE));
        }
        ...
        return new LoginIvleCommand( username, password ,moduleCode);
    }
