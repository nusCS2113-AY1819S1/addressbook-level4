...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_ENROLLED_MODULE = new Prefix("em/");
    ...
    public static final Prefix PREFIX_SELECT_FILE = new Prefix("file/");
    public static final Prefix PREFIX_FREE = new Prefix("f/");
}
