...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        parseAttendeesForEdit(argMultimap.getAllValues(PREFIX_ATTENDEE)).ifPresent(editPersonDescriptor::setAttendees);
    ...
    private Optional<Set<Attendee>> parseAttendeesForEdit(Collection<String> attendees) throws ParseException {
        ...
        Collection<String> attendeeSet = attendees.size() == 1 && attendees.contains("") ? Collections.emptySet() : attendees;
