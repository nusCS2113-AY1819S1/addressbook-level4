...
/**
 * Parses input arguments and creates a {@code ModuleViewCommand} object.
 */
public class ModuleViewCommandParser implements Parser<ModuleViewCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the {@code ModuleViewCommand}
     * and returns a {@code ModuleViewCommand} object for execution.
