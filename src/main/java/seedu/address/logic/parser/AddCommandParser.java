 ...
 */
public class AddCommandParser implements Parser<AddDCommand> {
    ...
    public AddDCommand parse(String args) throws ParseException {
        ...
        DistributorName name = ParserUtil.parseName(argMultimap.getValue(PREFIX_NAME).get());
        DistributorPhone phone = ParserUtil.parsePhone(argMultimap.getValue(PREFIX_PHONE).get());
