 ...
 */
public class ExportCommandOld extends Command {
    ...
    public ExportCommandOld(Index index, Filetype filetype) {
    ...
    public boolean equals(Object other) {
        ...
        // handles nulls
        if (!(other instanceof ExportCommandOld)) {
            return false;
        }

        // checks state
        ExportCommandOld e = (ExportCommandOld) other;
