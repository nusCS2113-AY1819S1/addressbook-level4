...
public class ClassAddStudentCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Assigns a student to a class for the system"
            + " for the system. "
            + "Parameters: "
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        if (classroomManager.findDuplicateClassroomStudent(classToAssignStudent, matricNo)) {
