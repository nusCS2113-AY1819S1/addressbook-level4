...
public class FindPhoneCommand extends Command {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.address.logic.commands.MemberCommand.FindPhoneCommand
                && predicate.equals(((seedu.address.logic.commands.MemberCommand.FindPhoneCommand) other).predicate));
    }
}
