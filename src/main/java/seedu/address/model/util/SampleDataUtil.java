    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    getApptSet(), EMPTY_NRIC, EMPTY_DATE_OF_BIRTH, new Height("180"),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    ...
                    getMedHistorySet(), getApptSet(APPT_EXAMPLE1, APPT_EXAMPLE4), EMPTY_NRIC, EMPTY_DATE_OF_BIRTH,
                    EMPTY_HEIGHT, EMPTY_WEIGHT, EMPTY_GENDER, EMPTY_BLOODTYPE, EMPTY_OCCUPATION, EMPTY_MARITAL_STATUS,
