    ...
    public static Event[] getSampleEvents() {
        return new Event[] {
            new Event(new Name("Basketball Session"), new Contact("Alex Yeoh"), new Phone("87438807"),
                    ...
                    new DateTime(new String("25/11/2018 11:30")), new Comment("{span}Comments Section{/span}{ol}{/ol}"),
            ...
            new Event(new Name("Night Study Session"), new Contact("Bernice Yu"), new Phone("99272758"),
                    ...
                    new DateTime(new String("10/10/2018 11:30")), new Comment("{span}Comments Section{/span}{ol}{/ol}"),
            ...
            new Event(new Name("House Themed Dinner"), new Contact("Charlotte Oliveiro"), new Phone("93210283"),
                    ...
                    new DateTime(new String("20/1/2018 11:30")), new Comment("{span}Comments Section{/span}{ol}{/ol}"),
            ...
            new Event(new Name("Cooking Club Tryouts"), new Contact("David Li"), new Phone("91031282"),
                    ...
                    new DateTime(new String("28/2/2018 11:30")), new Comment("{span}Comments Section{/span}{ol}{/ol}"),
            ...
            new Event(new Name("Migrant Workers Rights Sharing Session"), new Contact("Irfan Ibrahim"),
                    ...
                    new Comment("{span}This is a comment{/span}"), getTagSet("classmates"),
                    getAttendeeSet("Irfan Ibrahim")),
            new Event(new Name("Ultimate Frisbee Session"), new Contact("Roy Balakrishnan"), new Phone("92624417"),
                    ...
                    new DateTime(new String("5/7/2018 4:30")), new Comment("{span}Comments Section{/span}{ol}{/ol}"),
                    getTagSet("colleagues"), getAttendeeSet("Roy Balakrishnan"))
        };
    }
