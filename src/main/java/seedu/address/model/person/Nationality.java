...
public class Nationality {
     ...
     *
     * @param countryCode A valid country.
     */
    public Nationality(String countryCode) {
        requireNonNull(countryCode);
        checkArgument(isValidCountryCode(countryCode), MESSAGE_NAME_CONSTRAINTS);
        this.countryCode = countryCode;
    }

    /**
     * Returns true if a given string is a valid countryCode.
     */
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                ...
                && countryCode.equals(((Nationality) other).countryCode)); // state check
    }
