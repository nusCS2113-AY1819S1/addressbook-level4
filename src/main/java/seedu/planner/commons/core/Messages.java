...
public class Messages {
    ...
    public static final String MESSAGE_NONEXISTENT_RECORD_DISPLAYED_DATE = "The record date provided is non-existent.\n";
    public static final String MESSAGE_RECORDS_LISTED_OVERVIEW = "%1$d records listed!\n";
    public static final String MESSAGE_SUMMARY_MONEYFLOW_OVERVIEW = "Total money spent/received: %1$.2f\n";
