 ...
 */
public class ExcelDisplay extends UiPart<Region> {

    private static final Logger logger = LogsCenter.getLogger(UiManager.class);

    private static final String FXML = "ExcelDisplay.fxml";
    ...
    @FXML
    private AnchorPane excelDisplay;
