...
public class ProductTest {
    ...
    public void isSamePerson() {
        ...
        Product editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Product aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Product editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
